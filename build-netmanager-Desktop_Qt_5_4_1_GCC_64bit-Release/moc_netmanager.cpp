...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_netmanager_t, stringdata) + ofs \
...
const QMetaObject netmanager::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_netmanager.data,
...
void *netmanager::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_netmanager.stringdata))
