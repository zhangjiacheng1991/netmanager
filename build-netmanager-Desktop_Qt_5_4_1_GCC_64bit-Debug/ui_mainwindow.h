...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        widget_2->setGeometry(QRect(0, 0, 122, 359));
        pushButton = new QPushButton(widget_2);
        pushButton->setObjectName(QStringLiteral("pushButton"));
        pushButton->setGeometry(QRect(0, 0, 101, 27));
        pushButton_2 = new QPushButton(widget_2);
        pushButton_2->setObjectName(QStringLiteral("pushButton_2"));
        pushButton_2->setGeometry(QRect(0, 40, 101, 27));
        QFont font2;
        font2.setPointSize(9);
        pushButton_2->setFont(font2);
        pushButton_3 = new QPushButton(widget_2);
        pushButton_3->setObjectName(QStringLiteral("pushButton_3"));
        pushButton_3->setGeometry(QRect(0, 80, 101, 27));
        pushButton_4 = new QPushButton(widget_2);
        pushButton_4->setObjectName(QStringLiteral("pushButton_4"));
        pushButton_4->setGeometry(QRect(0, 120, 101, 27));
        toolBox->addItem(widget_2, QString::fromUtf8("\347\275\221\347\253\231\347\256\241\347\220\206"));
        page_2 = new QWidget();
        page_2->setObjectName(QStringLiteral("page_2"));
        page_2->setGeometry(QRect(0, 0, 122, 425));
        ...
        page->setGeometry(QRect(0, 0, 122, 359));
        pushButton_12 = new QPushButton(page);
        pushButton_12->setObjectName(QStringLiteral("pushButton_12"));
        pushButton_12->setGeometry(QRect(9, 170, 96, 27));
        pushButton_13 = new QPushButton(page);
        pushButton_13->setObjectName(QStringLiteral("pushButton_13"));
        pushButton_13->setGeometry(QRect(9, 70, 96, 27));
        pushButton_14 = new QPushButton(page);
        pushButton_14->setObjectName(QStringLiteral("pushButton_14"));
        pushButton_14->setGeometry(QRect(9, 120, 96, 27));
        ...
        scrollAreaWidgetContents->setGeometry(QRect(0, 0, 918, 532));
    ...
    void retranslateUi(QMainWindow *MainWindow)
    {
        ...
        pushButton->setText(QApplication::translate("MainWindow", "\346\267\273\345\212\240\347\275\221\347\253\231", 0));
        pushButton_2->setText(QApplication::translate("MainWindow", "\346\267\273\345\212\240\347\275\221\347\253\231\345\210\206\347\261\273", 0));
