...
public:
    ...
    void setupUi(QWidget *netList)
    {
        ...
        gridLayout_3->addLayout(horizontalLayout_6, 1, 0, 1, 3);
        ...
        gridLayout_3->addLayout(gridLayout, 2, 2, 1, 1);
        ...
        horizontalLayout_8->addWidget(BTN_Start);
        ...
        horizontalLayout_8->addWidget(BTN_StartCal);

        BTN_StopCal = new QPushButton(netList);
        BTN_StopCal->setObjectName(QStringLiteral("BTN_StopCal"));

        horizontalLayout_8->addWidget(BTN_StopCal);


        gridLayout_3->addLayout(horizontalLayout_8, 3, 2, 1, 1);

        listView = new QListView(netList);
        listView->setObjectName(QStringLiteral("listView"));

        gridLayout_3->addWidget(listView, 4, 0, 1, 3);
        ...
        gridLayout_3->addWidget(lineEdit_Time, 5, 1, 1, 1);
    ...
    void retranslateUi(QWidget *netList)
    {
        ...
        label_9->setText(QApplication::translate("netList", "\345\272\217\345\217\267", 0));
